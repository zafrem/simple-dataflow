<template>
  <div class="group-filter-sidebar">
    ...
    <div class="filter-section">
      ...
      <el-button
        ...
        <el-icon class="toggle-icon">
          <component :is="viewMode === 'grouped' ? Collection : Grid" />
        </el-icon>
        {{ viewMode === 'grouped' ? 'Group View' : 'Component View' }}
    ...
    <div class="content-section" v-if="viewMode === 'grouped'">
